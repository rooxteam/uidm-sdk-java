...
public class SsoAuthorizationHelper {

    public static HttpServletRequest getDefaultRequest() {
        return new DummyRequest();
    }

    private final static class DummyRequest extends HttpServletRequestWrapper {
